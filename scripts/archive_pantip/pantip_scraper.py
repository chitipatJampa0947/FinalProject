...
# Configuration
KEYWORDS = ['AI', 'Work from home', 'Hybrid working', 'Meeting', 'Deadline', 'Feedback', 'Soft skills', 
            'Hard skills', 'Upskill', 'Reskill', 'Growth mindset', 'Experience', 'Solution', 'Connection', 
            'Networking', 'Startup', 'Innovation', 'Leadership', 'Teamwork', 'Communication', 'Productivity', 
            'Work-life balance', 'Remote work', 'Career development', 'Job search', 'Interview tips', 'Salary negotiation', 
            'Personal branding', 'Time management', 'Stress management', 'Mental health at work', 'Diversity and inclusion', 
            'Employee engagement', 'Company culture', 'Performance review', 'Professional development', 'Mentorship', 
            'Workplace conflict', 'Collaboration', 'Creativity', 'Problem-solving', 'Decision-making', 'Emotional intelligence', 
            'Adaptability', 'Resilience', 'Critical thinking', 'Innovation in the workplace', 'Future of work', 'Gig economy', 
            'Freelancing', 'Entrepreneurship', 'Workplace trends', 'Digital transformation', 'Automation and AI in the workplace']
